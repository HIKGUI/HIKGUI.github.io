...
if(isset($_POST['submit'])){
    ...
    if( $dupltell >= 1) {
      ...
      $tellConf = true;
        ...
        //TRANSFORMA EM APENAS ANO
        $dtnasc = date("Y", strtotime($dtnasc));

        //RECEBE ANO ATUAL
        $data_atual = date("Y");

        //CALCULA A IDADE
        $idade = $data_atual - $dtnasc;
    ...
    if(isset($_POST['submit']))
            ...
            $sql = "INSERT INTO tb_usuarios (us_cpf, us_nome, us_tell, us_dat_nasc, us_sexo, us_senha, us_situacao, us_tipo)
            VALUES ($cpf, '$nome', $tell, '$dtnasc', '$sexo', '$senha', 'atv', 'cli')";
...
<!-- INSERINDO OS DADOS PARA O CADASTRO -->
  ...
  <div>
    ...
    <input class="form-control" type="text" id="senha" name="senha" maxlength="20">
  </div><br>
