            ...
            <tbody>
                ...
                while ($test = $sql->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    if ( $adm_log === 'cli') {
                      ...
                      $sql = $conn->prepare("SELECT case us_sexo when 'm' then 'Masculino' else 'Feminino' end As compl_sexo, case us_situacao when 'blk' then 'bloqueado' else 'Ativo' end As compl_sit, us_nome, us_tell, us_dat_nasc, us_cpf, us_situacao FROM tb_usuarios where us_cpf = $cpf" );            
                      $sql->execute();
                    }
                ...
                while($user_data=$sql->fetch(PDO::FETCH_ASSOC)) {
                  ?>
                         <tr>
                          ...
                          <a class='btn btn-sm btn-primary' title='Editar' href=" <?php echo "upclientes.php?cpf={$user_data['us_cpf']}";?>">
                          ...
                          <a class='btn btn-sm btn-danger' name='del' title='Deletar' href=" <?php echo "PHP/delete.php?cpf={$user_data['us_cpf']}";?>">
