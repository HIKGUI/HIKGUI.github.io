  ...
  if( $dupltell >= 1) {
    ...
    if(isset($_POST['submit']))
        ...
        if(($nomeConf === true) and ($cpfConf === true) and ($tellConf === true) and ($dtnascConf === true) and ($senhaConf === true)){
            ...
            $sql = "INSERT INTO tb_usuarios (us_cpf, us_nome, us_tell, us_dat_nasc, us_sexo, us_senha, us_situacao, us_tipo) VALUES ($cpf, '$nome', $tell, '$dtnasc', '$sexo', '$senha', 'atv', 'atd')";
...
<div id="titulos">
<h2>BLACKBEARD - Cadastro Atendentes</h2><br>
</div>
